...
IMGO.buildFilesExt = function() {
  if ( program.png || program.gif || program.ico || program.jpg ) {
    ...
    if (program.png) { IMGO.filesExt.push('.png'); };
    if (program.gif) { IMGO.filesExt.push('.gif'); };
    if (program.ico) { IMGO.filesExt.push('.ico'); }; 
    if (program.jpg) { IMGO.filesExt.push('.jpg'); IMGO.filesExt.push('.jpeg'); };
